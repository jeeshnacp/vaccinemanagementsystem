# Generated by Django 3.2.5 on 2022-01-27 14:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Address', models.TextField()),
                ('Email', models.EmailField(max_length=254)),
                ('ho', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='proapp.hospital')),
                ('lo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='proapp.login')),
            ],
        ),
        migrations.CreateModel(
            name='complaints',
            fields=[
                ...
                ('users', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='proapp.user')),
            ],
        ),
    ]
